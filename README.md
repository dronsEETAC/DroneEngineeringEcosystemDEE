...
* *Dashboard*:
[![DEE Badge](https://img.shields.io/badge/DEE-dashboard-brightgreen.svg)](https://github.com/dronsEETAC/DashboardDEE) a desktop application that allows the global control of the system. From the dashboard, 
